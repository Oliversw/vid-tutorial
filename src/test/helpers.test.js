...
describe("searchForTags function", () => {
  test("it should return all elements matching a single tag", () => {
  ...
  test("it should return all elements matching multiple tags", () => {
...
describe("sortbyRating function", () => {
  test("it should return an array sorted by rating", () => {
    const input = testData;
    const output = [
      {
        id: "ae8baabb-fc1c-4845-944a-bd1ddfb12f35",
